                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () => Get.back(),
                          child: iconWidget(icon: Icon(CupertinoIcons.back, color: MyColor.white), color: MyColor.white.withOpacity(0.2)),
                        ),
                        Text(
                          "Food Details",
                          style: TextStyle(fontSize: 18, color: MyColor.white),
                        ),
                        iconWidget(icon: (food['fav'])
                            ? Icon(CupertinoIcons.heart_fill, color: MyColor.red,)
                            : Icon(CupertinoIcons.heart, color: MyColor.white,), color: MyColor.white.withOpacity(0.2))
                      ],
                    ),
                  ),
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                child: Center(
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                          onPressed: () => controller.qtyIncrement(food.id, food['qty']),
                                          icon: Icon(
                                            Icons.add,
                                            color: MyColor.white,
                                          )),
                          ...
                          const Spacer(),
                          InkWell(
                            onTap: () => controller.addCart(context, food.id, food['cart']),
                            child: Container(
                              height: 55,
                              width: MySize.width,
